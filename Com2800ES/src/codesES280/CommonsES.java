...
public class CommonsES extends JPanel {
	...
	public CommonsES(BranchGroup sceneBG) {
	...
	public static void main(String[] args) {
		frame = new JFrame("ES's Common File");            // NOTE: change ES to student's initials
		frame.getContentPane().add(new CommonsES(create_Scene()));  // create an instance of the class
