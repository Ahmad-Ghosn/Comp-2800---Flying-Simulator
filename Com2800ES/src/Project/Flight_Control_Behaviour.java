...
public class Flight_Control_Behaviour extends Behavior implements KeyListener {
	...
	public Flight_Control_Behaviour(TransformGroup target, TransformGroup view, TransformGroup scene) {
		...
		this.listener = false;
		this.keyNavigator_target = new Flight_Control(target, view, scene);
	}
