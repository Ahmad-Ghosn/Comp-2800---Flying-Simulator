...
//Student: Dalyn Stephens
//Student Num: 104401415
//Date: 2023-01-17
...
public class CommonsDS extends JPanel {
	...
	public static RotationInterpolator rotate_Behavior(int r_num, TransformGroup rotTG) {
		...
		RotationInterpolator rot_beh = new RotationInterpolator(
				rotationAlpha, rotTG, xAxis, 0.0f, (float) Math.PI * 4.0f);
	...
	public static BranchGroup create_Scene() {
		...
		sceneBG.addChild(rotate_Behavior(1, sceneTG));
	...
	public CommonsDS(BranchGroup sceneBG) {
	...
	public static void main(String[] args) {
		frame = new JFrame("DS's Common File");            // NOTE: change DS to student's initials
		frame.getContentPane().add(new CommonsDS(create_Scene()));  // create an instance of the class
